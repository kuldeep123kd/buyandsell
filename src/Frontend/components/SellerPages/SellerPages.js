        ...
        <div className="sellerpage">
          <div className="container">
            <div className="sellerpage-sec1 text-center m-auto">
              <h1>"Since last year, my business on Buysell has grown more than 9 times.”</h1>
            ...
            <div className="sellerpage-sec2">
              ...
              <div className="row">
                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                  ...
                  <p>Start selling on Buysell - without building a website. Register now to start selling on Buysell.com.</p>
                </div>
                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                  <img src="..." alt="..." />
                  <h2>Reach crores of customers</h2>
                  <p>Sell to crores of engaged customer visiting Buysell.com on desktop and through our mobile app.</p>
                </div>
                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                  <img src="..." alt="..." />
                  <h2>Receive timely payments</h2>
                  <p>Buysell ensures your payments for your delivered orders are deposited directly in your bank account every 7 days.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            <div className="sellerpage-sec4 text-center">
              <Link to="/sellerform">Start Selling</Link>
              <p>No fixed subsription fee | Pay only when your product is ordered</p>
